...
For adding an audit rule R10. Use 000-implement.md for everything else.
...
- Does the stdlib handle the detection? (`re`, `datetime`, etc.) Yes, `re` and `datetime` date parsing.
